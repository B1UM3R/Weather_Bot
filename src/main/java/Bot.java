...
//        Graphic graphic = new Graphic(city, new int[]{1, 2, 3}, new int[]{10, -20, 30});
//        JFrame picture = graphic.createGraphic();
//        //picture.createImage(720,480);
//        photo.setNewPhoto(picture);
//    }
